<svelte:head>
	<title>Snowflakes.network | Web3 push notifications where you are in control</title>
</svelte:head>

<div class="py-4 bg-white overflow-hidden lg:py-8">
	<div class="relative mx-auto px-4 sm:px-6 lg:px-8">
		<div class="relative">
			<h2
				class="flex items-center justify-center text-center text-3xl leading-8 font-bold tracking-tight text-sky-600 sm:text-4xl"
			>
				<img class="h-8 w-auto mr-2" src="/snowflakes.network.svg" alt="snowflakes.network" />
				Snowflakes.network
			</h2>
		...
		<div class="relative mt-4 lg:mt-8 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
			...
			<div class="mt-10 -mx-4 relative lg:mt-0" aria-hidden="true">
				<img
					class="relative mx-auto rounded-xl"
					width="450"
					src="https://images.unsplash.com/photo-1614917752523-3e61c00e5e68?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1287&q=80"
					alt=""
				/>
			</div>
		</div>
		...
		<div class="relative mt-12">
			<div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
				...
				<div class="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
					<img
						class="relative mx-auto rounded-t-xl"
						width="415"
						src="https://images.unsplash.com/photo-1637593992672-ed85a851fdc3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2324&q=80"
						alt=""
					/>
					<img
						class="relative mx-auto rounded-b-xl"
						width="415"
						src="https://images.unsplash.com/photo-1637592156979-95f44c286423?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2413&q=80"
						alt=""
					/>
				</div>
			</div>
